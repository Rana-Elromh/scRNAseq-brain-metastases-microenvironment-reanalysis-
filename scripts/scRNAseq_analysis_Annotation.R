...
#==============================================================================
# Differential expression annotation of mergeed-singlets
#==============================================================================
...
new_cluster_ids <- c(
  ...
  "2"  = "Tumor_proliferating",
  "3"  = "Tumor_proliferating",
  "4"  = "Tumor_proliferating",
  "5"  = "Tumor",
  "6"  = "T_cell",
  "7"  = "Oligodendrocyte",
  "8"  = "Tumor",
...
Idents(merged_singlets) <- "seurat_clusters"
merged_singlets <- RenameIdents(merged_singlets, new_cluster_ids)
merged_singlets$cell_type <- Idents(merged_singlets)
